 ...
 *
 */
public class Vistransh2Transformer {
	/**
	 ...
	 */
	public static List<VistranshHeadDto> transform(List<Vistransh2Dao> vistranshDaoList) {
		final List<VistranshHeadDto> vistranshHeadtDtoList = new ArrayList<VistranshHeadDto>();
		
		Map<Integer, List<Vistransh2Dao>> groupedByBilnr = 
				vistranshDaoList
					.stream()
					.collect(groupingBy(Vistransh2Dao::getBilnr));
