...
public class CustomerDocumentController extends BaseController {    
    ...
    private static CustomerDocumentController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the CustomerDocumentController class 
     */
    public static CustomerDocumentController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new CustomerDocumentController();
            }
        }
        return instance;
    }
     ...
     */
    public List<CustomerDocumentDto> getCustomerDocumentGetAllDocuments(
        ...
        getCustomerDocumentGetAllDocumentsAsync(greaterThanValue, lastModifiedDateTime, lastModifiedDateTimeCondition, numberToRead, orderBy, released, skipRecords, callback);
     ...
     */
    public void getCustomerDocumentGetAllDocumentsAsync(
                final String greaterThanValue,
                final String lastModifiedDateTime,
                final String lastModifiedDateTimeCondition,
                final Integer numberToRead,
        ...
        _queryBuilder.append("/controller/api/v1/customerdocument");

        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5063860038176383660L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4726867161278126542L;
            {
