...
public class SupplierDocumentController extends BaseController {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static SupplierDocumentController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the SupplierDocumentController class 
     */
    public static SupplierDocumentController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new SupplierDocumentController();
            }
        }
        return instance;
    }
     ...
     */
    public List<SupplierDocumentDto> getSupplierDocumentGetAllDocumentsForSupplier(
        ...
        getSupplierDocumentGetAllDocumentsForSupplierAsync(greaterThanValue, lastModifiedDateTime, lastModifiedDateTimeCondition, numberToRead, orderBy, released, skipRecords, callback);
     ...
     */
    public void getSupplierDocumentGetAllDocumentsForSupplierAsync(
                final String greaterThanValue,
                final String lastModifiedDateTime,
                final String lastModifiedDateTimeCondition,
                final Integer numberToRead,
        ...
        _queryBuilder.append("/controller/api/v1/supplierdocument");

        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4909437469356608951L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5241602168787649318L;
            {
