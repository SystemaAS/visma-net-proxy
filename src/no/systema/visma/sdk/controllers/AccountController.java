...
import no.systema.visma.sdk.models.AccountDto;
...
public class AccountController extends BaseController {    
     ...
     * @return    Returns the List<AccountDto> response from the API call 
     */
    public List<AccountDto> getAccountGetAll(
        ...
        APICallBackCatcher<List<AccountDto>> callback = new APICallBackCatcher<List<AccountDto>>();
        getAccountGetAllAsync(greaterThanValue, lastModifiedDateTime, lastModifiedDateTimeCondition, numberToRead, orderBy, skipRecords, callback);
     ...
     */
    public void getAccountGetAllAsync(
                final String greaterThanValue,
                final String lastModifiedDateTime,
                final String lastModifiedDateTimeCondition,
                final Integer numberToRead,
                final String orderBy,
                final Integer skipRecords,
                final APICallBack<List<AccountDto>> callBack
    ) {
        ...
        _queryBuilder.append("/controller/api/v1/account");

        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5213972466038916811L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5031872477484860853L;
            {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            List<AccountDto> _result = APIHelper.deserialize(_responseBody,
    ...
    /**
     * TODO: type endpoint description here
     * @param    accountCd    Required parameter: Identifies the account
     * @return    Returns the AccountDto response from the API call 
     */
    public AccountDto getAccountGet(
                final String accountCd
    ) throws Throwable {
        APICallBackCatcher<AccountDto> callback = new APICallBackCatcher<AccountDto>();
        getAccountGetAsync(accountCd, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void getAccountGetAsync(
                final String accountCd,
                final APICallBack<AccountDto> callBack
    ) {
        //the base uri for api requests
        String _baseUri = Configuration.baseUri;
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/controller/api/v1/account/{accountCd}");

        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4720894699238158908L;
            {
                    put( "accountCd", accountCd );
            }});
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5645366717177674741L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "Authorization", String.format("Bearer %1$s", Configuration.oAuthAccessToken) );
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            //extract result from the http response
                            String _responseBody = ((HttpStringResponse)_response).getBody();
                            AccountDto _result = APIHelper.deserialize(_responseBody,
