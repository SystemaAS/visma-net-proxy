...
import no.systema.visma.sdk.models.LedgerDto;

public class LedgerController extends BaseController {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static LedgerController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the LedgerController class 
     */
     ...
     * @return    Returns the List<LedgerDto> response from the API call 
     */
    public List<LedgerDto> getLedgerGetAllLedgers(
        ...
        APICallBackCatcher<List<LedgerDto>> callback = new APICallBackCatcher<List<LedgerDto>>();
        getLedgerGetAllLedgersAsync(greaterThanValue, lastModifiedDateTime, lastModifiedDateTimeCondition, numberToRead, orderBy, skipRecords, callback);
     ...
     */
    public void getLedgerGetAllLedgersAsync(
                final String greaterThanValue,
                final String lastModifiedDateTime,
                final String lastModifiedDateTimeCondition,
                final Integer numberToRead,
                final String orderBy,
                final Integer skipRecords,
                final APICallBack<List<LedgerDto>> callBack
    ) {
        ...
        _queryBuilder.append("/controller/api/v1/ledger");

        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5011338987446172921L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4737409726683827389L;
            {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            List<LedgerDto> _result = APIHelper.deserialize(_responseBody,
