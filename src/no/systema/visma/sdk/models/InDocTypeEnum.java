...
public enum InDocTypeEnum {
    ...
    private static TreeMap<String, InDocTypeEnum> valueMap = new TreeMap<String, InDocTypeEnum>();
    ...
    public static InDocTypeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of InDocTypeEnum values to list of string values
     * @param toConvert The list of InDocTypeEnum values to convert
     * @return List of representative string values */
    public static List<String> toValue(List<InDocTypeEnum> toConvert) {
        if(toConvert == null)
            return null;
        List<String> convertedValues = new ArrayList<String>();
        for (InDocTypeEnum enumValue : toConvert) {
