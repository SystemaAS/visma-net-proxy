...
public class InventoryIssueDto 
    ...
    private static final long serialVersionUID = 5069983167955396001L;
    ...
    private List<InventoryIssueLineDto> issueLines;
     ...
     * The manually entered summary amount for all specified inventory items. Control Amount is available only if the Validate Document Totals on Entry option is selected on the Inventory Preferences form. If the Control Amount and Total Amount values do not match, the system generates a warning message and the issue cannot be saved.
     */
    @JsonSetter("controlAmount")
    public void setControlAmount (Double value) { 
     ...
     */
    @JsonGetter("issueLines")
    public List<InventoryIssueLineDto> getIssueLines ( ) { 
     ...
     * The inventory issue lines
     */
    @JsonSetter("issueLines")
    public void setIssueLines (List<InventoryIssueLineDto> value) { 
        this.issueLines = value;
    }
